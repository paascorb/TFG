...
class MenuBF(QMainWindow):
    def __init__(self):
        ...
        self.gridLayout_fijo.addWidget(self.table_outputs, 4, 0, 1, 2)
    ...
    def add_layout_mod(self):
        ...
        self.gridLayout_dinamico.addWidget(self.pushButton_Aceptar, 6, 2, 1, 1, QtCore.Qt.AlignRight)
        ...
        self.gridLayout_dinamico.addWidget(self.table_ouputs, 4, 1, 2, 2)
        ...
        self.gridLayout_dinamico.addLayout(self.verticalLayout, 4, 0, 1, 1)
