...
# Form implementation generated from reading ui file 'TFG_SC_Menu_Expansion.ui'
#
...
"background-color: rgb(177, 177, 177);")
        ...
        self.list_simplex.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.list_simplex.addItem(item)
...
"")
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 986, 29))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, TFG):
        ...
        self.line_cone_name.setPlaceholderText(_translate("TFG", "Nombre Complejo"))
        ...
        item = self.list_simplex.item(0)
        item.setText(_translate("TFG", "Hola"))
        item = self.list_simplex.item(1)
        item.setText(_translate("TFG", "Yes"))
