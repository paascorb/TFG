...
class TestBooleanFunction(unittest.TestCase):
    ...
    def test_check_output(self):
        self.assertTrue([2, 4].sort() == Aux.check_output(6).sort())
        self.assertTrue([6, 5, 4, 3, 2, 1].sort() == Aux.check_output(7).sort())
        self.assertTrue(list(range(1, 31)).sort() == Aux.check_output(31).sort())
        #self.assertTrue(list(range(1, 1023)).sort() == Aux.check_output(1023).sort())
